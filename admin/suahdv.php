...
<html lang="en"><head>
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
              <h1 class="h3 mb-0 text-gray-800">Sửa thông tin hướng dẫn viên</h1>
            ...
            <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Sửa thông tin hướng dẫn viên</h1>
                  </div>
                  <form class="user" action="" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="exampleInputEmail" disabled placeholder="Mã hdv: <?php echo $_GET['sua']?>" name="txtma" values="<?php echo $_GET['sua']?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                     ...
                     Giới tính <input type="radio" name="txtphai" value="0" checked>Nam
                    ...
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="exampleInputPassword" placeholder="Số diện thoại" name="txtsdt">
                    </div>
                    <div class="form-group">
  ...
  <?php
    ...
    if(isset($_POST['ok'])){
      ...
      $num = $DB->check_row("select * from huongdanvien where ma_hdv='$mahdv'");
      
      if(empty($tenhdv)||empty($phai)||empty($diachi)||empty($sdt)||empty($anh) ){
        echo "<script>alert('Nhập thiếu thông tin')</script>";
      }else {
        if ($num>=1 && $row['ma_hdv']!=$mahdv) {
          echo "<script>alert('Mã du lịch đã tồn tại')</script>";
        }else {
          $mahdv = $_GET['sua'];
           $run =  $DB->update('huongdanvien', array(
