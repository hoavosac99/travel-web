...
<html lang="en"><head>
        ...
        <li class="nav-item">
          ...
          <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar" style="">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="login.html">Tất cả hướng dẫn viên</a>
              <a class="collapse-item" href="register.html">Thêm hướng dẫn viên</a>
              <a class="collapse-item" href="forgot-password.html">Hướng dẫn viên đang đi tour</a>
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
              <h1 class="h3 mb-0 text-gray-800">Sửa tour</h1>
            ...
            <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Sửa tour du lịch</h1>
                  </div>
                  <form class="user" action="" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="exampleInputEmail" disabled placeholder="<?php echo $_GET['sua']?>" name="txtma" values="<?php echo $_GET['sua']?>">
                    </div>
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="exampleInputPassword" placeholder="Tên tour" name="txtten">
                    </div>
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="exampleInputPassword" placeholder="Ngày bắt đầu" name="txtnbd">
                    </div>
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="exampleInputPassword" placeholder="Ngày kết thúc" name="txtnkt">
                    </div>
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="exampleInputPassword" placeholder="Giá vé" name="txtgiave">
                    </div>
                    <div class="form-group">
                      <input type="file" class="form-control" id="exampleInputPassword" placeholder="Ảnh trưng bày" name="hinhanh">
                    </div>
                    <input type="submit" href="" class="btn btn-primary btn-user btn-block" name="ok" value="Đồng ý sửa">
  ...
  <?php
    ...
    if(isset($_POST['ok'])){
      ...
      $tentour = $_POST['txtten'];
      $ngaybd = $_POST['txtnbd'];
      $ngaykt = $_POST['txtnkt'];
      $giave = $_POST['txtgiave'];
      $filetam=$_FILES['hinhanh']['tmp_name'];
       $filethuc=$_FILES['hinhanh']['name'];  
      move_uploaded_file($filetam,'../img/place/'.$filethuc);
      $anh=basename($filethuc,'');
  
      $row=$DB->get_row("select * from tour where ma_tour='$matour'");
      $num = $DB->check_row("select * from tour where ma_tour='$matour'");
      
      if(empty($tentour)||empty($ngaybd)||empty($ngaykt)||empty($giave)||empty($anh) ){
        echo "<script>alert('Nhập thiếu thông tin')</script>";
      }else {
        if ($num>=1 && $row['ma_tour']!=$matour) {
          echo "<script>alert('Mã du lịch đã tồn tại')</script>";
        }else {
          $matour = $_GET['sua'];
           $run =  $DB->update('tour', array(
