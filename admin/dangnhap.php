              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" action="" method="POST">
                    ...
                    <div class="form-group">
                      <input type="password" class="form-control form-control-user" id="exampleInputPassword" placeholder="Mật khẩu" name="pass">
                    </div>
                    <div class="form-group">
                    ...
                    <input type="submit" href="index.html" class="btn btn-primary btn-user btn-block" value="Đăng nhập" name="dangnhap">
...
<?php
    ...
    $DB = new classfuntion();
    $DB->check_row('select * from admin');
    if(isset($_POST['dangnhap'])){
        $email = $_POST['email'];
        $pass = $_POST['pass'];
       $hehe= $DB->get_row('select * from admin');
       if($email==$hehe['email'] && $pass==$hehe['password']){ 
         header('location: admin.php');
         $_SESSION['admin'] = $hehe['id'];
       }else{
           echo "<script>alert('mật khẩu hoặc email sai')</script>";
       }
    }
?>