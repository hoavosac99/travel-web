...
<html lang="en"><head>
            ...
            <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Thêm tour du lịch</h1>
                  </div>
                  <form class="user" action="" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="exampleInputEmail" placeholder="Mã tour" name="txtma">
                    </div>
                    <div class="form-group">
  ...
  <?php
    ...
    if(isset($_POST['ok'])){
      ...
      if(empty($matour)||empty($tentour)||empty($ngaybd)||empty($ngaykt)||empty($giave)||empty($anh) ){
