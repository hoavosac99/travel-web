...
<html lang="en"><head>
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
              <h1 class="h3 mb-0 text-gray-800">Viết bài du lịch</h1>
            ...
            <div class="col-lg-10">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Viết bài du lịch</h1>
                  </div>
                  <form class="user" action="" method="POST" enctype="multipart/form-data">
                    
                   <textarea name="txtbaiviet" id="" cols="90" rows="10" style="width: 100%;"></textarea>
  ...
  <?php
    ...
    if(isset($_POST['ok'])){
      $baiviet =$_POST['txtbaiviet'];
        $id_tour = $_GET['viet'];
         $test= $DB->update('tour', array(
            'content' =>$baiviet
           ),"ma_tour='$id_tour'");
           if($test){
            ...
            echo "<script>alert('không thêm được bài viết')</script>";
           }
